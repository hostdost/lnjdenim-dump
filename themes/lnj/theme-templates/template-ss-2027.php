<?php
/*
*Template Name: Template SS 2027
*/
?>
<?php
get_header('sw');
    ...
    <div class="container">
        <div class="row" style="">
            <div class="col span_12">
                <div class="">
                    <?php if (!isMobile()) { ?>
                        <img src="<?php echo site_url(); ?>/assets/ss27-banner.png" alt="">
                    <?php } ?>
                    <?php if (isMobile()) { ?>
                        <img src="<?php echo site_url(); ?>/assets/ss27-banner.png" alt="">
                    <?php } ?>
        ...
        <div class="row">
            <div class="col span_12 youTubeVideo">
                ...
                <div class="customcoverImage" id="play-button"
                    style="height:500px; background: url('<?php echo site_url(); ?>/assets/ss27-banner.png'); background-size: cover; background-position: center center; opacity: 1; transition: opacity 1s ease-in-out; height:500px;">
...
<section class="banner-block-section">
    <div class="container">
        <div class="row banner-block-box banner-block-box-first" style="background-color: #7ac0f9; padding:25px;">
            <div class="col-md-4 col-12" style="margin: 0 auto;">

                <div class="sec-banner-wrap">
                    <div class="sec-banner-box"
                        style="background:url(https://lnjdenim.in/assets/ss27-book-thumb.png);background-size: cover;background-repeat: no-repeat;">
                        <a href="#" data-toggle="modal" data-target="#modal-default"><img
                                src="https://lnjdenim.in/assets/ss27-book-thumb.png" alt=""></a>
                    </div>
                    <div class="third-banner-box" style="background-color: #08329e;">
                        <div class="third-text-box  box-tabel">
                            <div class="box-tabel-cell">
                                <h2 class="wow fadeIn" data-wow-duration="0.3s" data-wow-delay="0.6s"
                                    ...
                                    <a href="#" data-toggle="modal1"
                                        data-target="#modal-default1">LUMEN SS27</a>
                                </h2>
