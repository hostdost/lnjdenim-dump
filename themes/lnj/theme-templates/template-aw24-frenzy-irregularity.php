<?php
/*
*Template Name: AW 24 - Frenzy Irregularity
*/
?>
<?php
get_header('sw');
    ...
    <div class="container">
        <div class="row">
            <div class="main-head pl-3">
                <h1><span><a href="<?php echo get_the_permalink(644) ?>">FW 2024</a></span> > <span><?php echo the_title(); ?></span></h1>
            </div>
        </div>
        <div class="row">
            <?php
            $entries = get_post_meta(652, 'wiki_test_repeat_group', true);
            //print_r($entries);
                ...
                <div class="col-6 col-md-2 col-lg-2 span_2 item wow fadeIn">
                    <div class="sping-summer-wrap">
                        <div class="summer-sping-img" style="background: #bebdc129;">
                            <a href="<?php echo get_the_permalink(668); ?>?cat=647&article=652&index=<?php echo $key; ?>">
                            ...
                            <div class="summer-sping-caption">
                                ...
                                <p><a href="<?php echo get_the_permalink(668); ?>?cat=647&article=652&index=<?php echo $key; ?>">
