<?php
/*
*Template Name: SS 25 - Essentials
*/
?>
<?php
get_header('sw');
    ...
    <div class="container">
        <div class="row" style="">
            <div class="col span_12">
                <div class="">
                    <?php if (!isMobile()) { ?>
                        <img src="<?php echo site_url(); ?>/assets/ss-25-essentials-banner.png" alt="">
                    <?php } ?>
                    <?php if (isMobile()) { ?>
                        <img src="<?php echo site_url(); ?>/assets/ss-25-essentials-banner.png" alt="">
                    <?php } ?>
...
<section class="sping-summer-section winter-2019">
    <div class="container">
        ...
        <div class="row">
            <?php
            $entries = get_post_meta(918, 'wiki_test_repeat_group', true);
            //print_r($entries);
                    ...
                    <div class="sping-summer-wrap">
                        <div class="summer-sping-img" style="background: #bebdc129;">
                                ...
                                <a target="_blank" href="<?php echo get_the_permalink(927) 
                                                                ?>?article=918&index=<?php echo $key; 
                                                                                        ?>"> 
