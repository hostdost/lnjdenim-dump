    ...
    <div class="container">
        <div class="row" style="">
            <div class="col span_12">
                <div class="">
                    <?php if (!isMobile()) { ?>
                        <img src="<?php echo site_url(); ?>/assets/ss-25-kamicia-banner.png" alt="">
                    <?php } ?>
                    <?php if (isMobile()) { ?>
                        <img src="<?php echo site_url(); ?>/assets/ss-25-kamicia-banner.png" alt="">
                    <?php } ?>
    ...
    <div class="container">
        <div class="row">
            <div class="main-head pl-3">
                <h1><span><a href="<?php echo get_the_permalink(906) ?>">SS 25</a></span> > <span><?php echo the_title(); ?></span></h1>
            </div>
        </div>
        <div class="row">
            <?php
            $entries = get_post_meta(922, 'wiki_test_repeat_group', true);
            //print_r($entries);
                ...
                <div class="col-6 col-md-2 col-lg-2 span_2 item wow fadeIn">
                    <div class="sping-summer-wrap">
                        <div class="summer-sping-img" style="background: #bebdc129;">
                                ...
                                <a target="_blank" href="<?php echo get_the_permalink(927) 
                                                                ?>?cat=916&article=922&index=<?php echo $key; 
                                                                                        ?>">  
                            ...
                            <div class="summer-sping-caption">
                                ...
                                <p>
                                    <a target="_blank" href="<?php echo get_the_permalink(927) 
                                                                    ?>?article=922&index=<?php echo $key; 
                                                                                            ?>"> 
