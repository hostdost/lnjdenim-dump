<?php
/*
*Template Name: AW 25 - Essential Echo
*/
?>
<?php
get_header('sw');
    ...
    <div class="container">
        <div class="row" style="">
            <div class="col span_12">
                <div class="">
                    <?php if (!isMobile()) { ?>
                        <img src="<?php echo site_url(); ?>/assets/aw25-essential-echoes-banner.png" alt="">
                    <?php } ?>
                    <?php if (isMobile()) { ?>
                        <img src="<?php echo site_url(); ?>/assets/aw25-essential-echoes-banner.png" alt="">
                    <?php } ?>
...
<section class="sping-summer-section winter-2019">
    <div class="container">
        ...
        <div class="row">
            <?php
            $entries = get_post_meta(1208, 'wiki_test_repeat_group', true);
            //print_r($entries);
            foreach ((array) $entries as $key => $entry) { ?>
                <div class="col-6 col-md-2 col-lg-2 span_2 item wow fadeIn">
                    <div class="sping-summer-wrap">
                        ...
                        <a target="_blank" href="<?php echo get_the_permalink(1204);?>?cat=1198&article=1208&index=<?php echo $key;?>">
                            ...
                            <div class="summer-sping-caption">
                                ...
                                <p><a target="_blank" href="<?php echo get_the_permalink(1204);?>?cat=1198&article=1208&index=<?php echo $key;?>">
