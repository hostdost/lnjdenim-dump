<?php
/*
*Template Name: Template SS 2026 Dev
*/
?>
<?php
get_header('sw');
    ...
    <div class="container">
        <div class="row" style="">
            <div class="col span_12">
                <div class="">
                    <?php if (!isMobile()) { ?>
                        <img src="<?php echo site_url(); ?>/assets/ss26-banner.png" alt="">
                    <?php } ?>
                    <?php if (isMobile()) { ?>
                        <img src="<?php echo site_url(); ?>/assets/ss26-banner.png" alt="">
                    <?php } ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col span_12 youTubeVideo">
                ...
                <div class="customcoverImage" id="play-button" style="height:500px; background: url('<?php echo site_url(); ?>/assets/ss26-banner.png'); background-size: cover; background-position: center center; opacity: 1; transition: opacity 1s ease-in-out; height:500px;">
    ...
    <div class="row banner-block-box banner-block-box-first" style="background-color: #888888; padding:25px;">
        <div class="col-md-4 col-12" style="margin: 0 auto;">
                ...
                <div class="sec-banner-wrap">
                    <div class="sec-banner-box" style="background:url(https://lnjdenim.in/assets/ss26-book-thumb.png);background-size: cover;background-repeat: no-repeat;">
                        <a href="#"  data-toggle="modal" data-target="#modal-default"><img src="https://lnjdenim.in/assets/ss26-book-thumb.png" alt=""></a>
                    </div>
                    <div class="third-banner-box" style="background-color: #b05a7a;">
                        <div class="third-text-box  box-tabel">
                            <div class="box-tabel-cell">
                                <h2 class="wow fadeIn" data-wow-duration="0.3s" data-wow-delay="0.6s" style="visibility: visible; animation-duration: 0.3s; animation-delay: 0.6s; animation-name: fadeIn;">
                                    <a href="#" data-toggle="modal" data-target="#modal-default">EVOLVE SS26</a>
                                </h2>
                                <h3 class="wow fadeIn" data-wow-duration="0.4s" data-wow-delay="0.8s" style="visibility: visible; animation-duration: 0.4s; animation-delay: 0.8s; animation-name: fadeIn;">
                                    <a href="#"  data-toggle="modal" data-target="#modal-default">
                                         </a>
                                </h3>
                                <div class="arrow-box-icon wow fadeIn" data-wow-duration="0.5s" data-wow-delay="1s" style="visibility: visible; animation-duration: 0.5s; animation-delay: 1s; animation-name: fadeIn;">
                                    <a href="#"  data-toggle="modal" data-target="#modal-default">
                                        <img src="https://lnjdenim.in/wp-content/themes/lnj/img/white-right-arrow.png" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
