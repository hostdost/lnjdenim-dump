<?php
/*
*Template Name: AW 25 - Resonant Gear
*/
?>
<?php
get_header('sw');
    ...
    <div class="container">
        <div class="row" style="">
            <div class="col span_12">
                <div class="">
                    <?php if (!isMobile()) { ?>
                        <img src="<?php echo site_url(); ?>/assets/aw25-resonant-gear-banner.png" alt="">
                    <?php } ?>
                    <?php if (isMobile()) { ?>
                        <img src="<?php echo site_url(); ?>/assets/aw25-resonant-gear-banner.png" alt="">
                    <?php } ?>
...
<section class="sping-summer-section winter-2019">
    <div class="container">
        ...
        <div class="row">
            <?php
            $entries = get_post_meta(1209, 'wiki_test_repeat_group', true);
            //print_r($entries);
                ...
                <div class="col-6 col-md-2 col-lg-2 span_2 item wow fadeIn">
                    <div class="sping-summer-wrap">
                        <div class="summer-sping-img" style="background: #bebdc129;">
                            <a target="_blank" href="<?php echo get_the_permalink(1204); ?>?cat=1200&article=1209&index=<?php echo $key; ?>">
