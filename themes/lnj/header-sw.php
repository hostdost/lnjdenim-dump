...
<head>
    ...
    <link rel="stylesheet" href="<?php echo esc_url(get_template_directory_uri()); ?>/js/fancybox/jquery.fancybox.css" type="text/css">
    <link rel="stylesheet" href="<?php echo esc_url(get_template_directory_uri()); ?>/js/slick-js/slick.css" type="text/css">
    <link rel="stylesheet" href="<?php echo esc_url(get_template_directory_uri()); ?>/js/slick-js/slick-theme.css" type="text/css">
...
<body <?php body_class(); ?>>
    ...
    <div class="wrapper">
        ...
        <nav class="wow fadeInDown">
            <div class="container">
                <div class="row">
                    <div class="col-1 col span_1">
                        <div class="nav-center-logo">
                            <div class="nav-logo-text wow fadeInDown" data-wow-delay="0.3s">
                                <a href="<?php echo site_url() ?>"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/logo.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-11 col span_11 desktop  d-none d-xs-none d-sm-none d-md-block">
